...
import 'package:bnshop/controller/chat_controller.dart';
import 'package:bnshop/services/firestore_services.dart';
import 'package:bnshop/views/chat_screen/components/sender_bubble.dart';
    ...
    return Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              Obx(()=>
              controller.isloaing.value ? Center(
