...
import 'package:bnshop/views/category_screen/category_detals.dart';
          ...
          body: Container(
            ...
            child: GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    mainAxisSpacing: 8,
                    crossAxisSpacing: 8,
                    mainAxisExtent: 200), itemBuilder: (context, index) {
              return Column(
                children: [
                  Image.asset(
                  ...
                  10.heightBox,
                  "${categoriesList[index]}".text.color(darkFontGrey).align(
